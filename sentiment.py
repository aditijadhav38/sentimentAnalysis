...
def main():
	data = pd.read_csv("./Dataset_Emotion/dataset_7ksamples.csv", error_bad_lines=False)
	...
	#data = data.drop(['ID', 'sentimentID'], 1)
	...
	## Segregate tweets and their labels in separate lists
	...
	#sentiment = ViewClassName(class_name)
